...
public class Config
{
    ...
    public static final ModConfigSpec.IntValue BOSS_FIGHT_PET_LIMIT = BUILDER
    ...
    public static final ModConfigSpec.IntValue SUMMON_BOTTLE_RIGHT_OFFSET = BUILDER
    ...
    public static final ModConfigSpec.IntValue SUMMON_BOTTLE_VERTICAL_OFFSET = BUILDER
