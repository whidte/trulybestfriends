...
> 让你的宠物永远陪伴在身边 —— 一个面向 Minecraft 1.21.1（NeoForge）的宠物管理模组，立志做最好的 Minecraft 宠物管理模组。
...
- 1.21.1 版本支持[机械动力：航空学](https://www.mcmod.cn/class/26350.html)。
- 安装 Curios 9.5.1+ 后，宠物饰品会随完整实体快照一同备份和恢复。
